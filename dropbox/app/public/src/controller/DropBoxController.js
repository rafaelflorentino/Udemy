class DropBoxController {
    ...
    constructor() {
        ...
        this.onselectionchange = new Event('selectionchange'); // cria um novo evento
        ...
        this.listFilesEl = document.querySelector('#list-of-files-and-directories');/*Listar arquivos local */
        
        this.btnNewFolder = document.querySelector('#btn-new-folder');
        this.btnRename = document.querySelector('#btn-rename');
        this.btnDelete = document.querySelector('#btn-delete');

        this.connectFirebase(); /* Conectar com banco de dados firebase */
        this.initEvents();
        this.readFiles();
    ...
    connectFirebase() {
        ...
        const config = {
            apiKey: "AIzaSyCPst9rykoIkvuN4n4twBt-OibzAEkKCYg",
            authDomain: "dropbox-clone-2f9f8.firebaseapp.com",
            databaseURL: "https://dropbox-clone-2f9f8-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-2f9f8",
            storageBucket: "dropbox-clone-2f9f8.appspot.com",
            messagingSenderId: "265228667425",
            appId: "1:265228667425:web:8d2d01089ceb232e96b160",
            measurementId: "G-D4KMDMMQBB"
          };
    ...
    initEvents() {
      ...
      this.btnRename.addEventListener('click', e =>{
        ...
        if(name){
            ...
            this.getFirebaseRef().child(li.dataset.key).set(file); // altera no banco de dados o nome
        }

      });

        // faz aparecer e sumir botoes de rename delete      
        ...
        this.inputFilesEl.addEventListener('change', (event) => { /* Dispara click no botão oculto */
            ...
            /* Acassar banco de dados firebase */
