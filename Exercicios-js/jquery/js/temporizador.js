(function ($){
    $.fn.temporizador = function (opcoes){
        const opcoesFinais = $.extend({//mensagem e hora padrao, caso nao seja passado
            mensagem: 'Em breve!',
            horario: '23:59:59'
        }, opcoes)//se for passado opcoes sobrescreve mensagem e horario
        ...
        const regex = new RegExp(/(\d\d):(\d\d):(\d\d)/)//caputurar: hora, minuto segundos
        const horarioAlvo = regex.exec(opcoesFinais.horario)//recebendo dados da funcao
        ...
        let temporizador = setInterval(()=>{
            ...
            if(diferencaEmMili >= 0){
                ...
                clearInterval(temporizador)// qunado zerar o tempo limpar
            }
